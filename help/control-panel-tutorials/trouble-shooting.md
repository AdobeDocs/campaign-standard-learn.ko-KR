...
**방법:**
사용자가  [!DNL IMS Org ID] (xxx)를 찾아야 합니다. 관리자는 관리할 각 인스턴스에 대해 사용자를 [!UICONTROL product profile] [!DNL “Campaign-xxx-Admins”]에 추가해야 합니다. 사용자가 모든 인스턴스의 관리자인 경우 자신을 *[!UICONTROL user]*(으)로 추가해야 합니다.
...
**방법:**
관리자는 관리할 각 인스턴스에  [!UICONTROL product profile] *[!DNL Campaign-xxx-Admins]* 대해 사용자를에 추가해야 합니다. 사용자가 모든 인스턴스의 관리자인 경우 자신을 *[!UICONTROL user]*(으)로 추가해야 합니다.

### 증상: 인스턴스가 [!UICONTROL Control Panel]에 나열되지 않음

**원인:**
누락된 인스턴스에 대해  *[!UICONTROL user]* 제품 프로필 `Campaign-xxx-Administrators/Admin` 로 사용자가 추가되어야 할 가능성이 높음

**방법:**
관리자는 관리할 각 인스턴스에 대해 사용자 `Campaign-xxx-Admins` 를 제품 프로필에 추가해야 합니다. 사용자가 모든 인스턴스의 관리자인 경우 자신을 *[!UICONTROL user]*(으)로 추가해야 합니다.
