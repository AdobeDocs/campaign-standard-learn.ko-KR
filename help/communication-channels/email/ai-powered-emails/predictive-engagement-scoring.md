...
[!UICONTROL Predictive engagement scoring] 은(는) 메시지를 받는 사람이 메시지에 얼마나 관심을 가질 것인지와 다음 이메일을 보낸 후 7일 이내에 메시지를 옵트 아웃(구독 취소)할 가능성을 예측합니다. 확률을 비참여, 보통 또는 낮음의 구체적인 위험에 따라 버킷으로 더 나눕니다. 또한 이 모델은 고객이 다른 고객과 비교하여 특정 고객의 등급을 이해할 수 있도록 위험 백분위수 등급을 제공합니다.
