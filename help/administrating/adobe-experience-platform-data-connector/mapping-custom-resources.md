---
title: '사용자 지정 리소스 매핑 '
description: ACS(Adobe Campaign Standard)와 Adobe Experience Platform(AEP) 간에 서로 다른 데이터 유형을 매핑하는 방법 학습
...
Adobe Campaign Standard와 Adobe Experience Platform 간의 다양한 데이터 유형을 매핑하는 방법을 알아봅니다.
