...
11월부터 1월 초까지 전송되는 마케팅 이메일의 양이 크게 증가합니다. 사서함 공급자(ISP)는 올해 남은 기간보다 서버에 유입되는 트래픽이 훨씬 많을 것이며 그 결과 고객(구독자)을 보호하는 데 훨씬 더 주의를 기울일 것입니다.
...
* 이메일을 예약하는 방법에 대해 생각해 보고 전송 볼륨이 크게 증가하지 않도록 하십시오. 다음과 같은 몇 가지 전술을 고려하십시오.
   * 동시에 폭발이 아니라 며칠에 걸쳐
