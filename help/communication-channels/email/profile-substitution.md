...
자세한 내용은 제품 설명서 를 참조하십시오 [대상 프로필을 사용하여 메시지 테스트](https://experienceleague.adobe.com/docs/campaign-standard/using/testing-and-sending/preparing-and-testing-messages/testing-messages-using-target.html?lang=en)
