...
Adobe Campaign 관리자는 [!UICONTROL Control Panel]을(를) 통해 주요 자산을 모니터링하고 [!DNL SFTP] 저장소를 인스턴스별로 관리, [!DNL GPG] 키 관리 또는 [!UICONTROL subdomains] 및 [!UICONTROL certificates] 관리 등의 관리 작업을 수행할 수 있습니다.

Campaign 컨트롤 패널에 액세스하는 방법과 컨트롤 패널에서 사용할 수 있는 사전 요구 사항을 알아봅니다.
